...
model.load_state_dict(load_state_dict('./models/checkpoints/4_15_LR/checkpoint-epoch=17.ckpt', location='cuda'))
# model.load_state_dict(load_state_dict('./models/checkpoints/checkpoint-epoch=8.ckpt', location='cuda'))
